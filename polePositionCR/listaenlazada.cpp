...
// Insertar al inicio
template<typename T>
void listaenlazada<T>::add_head(T data_)
{
...
// Insertar al final
template<typename T>
void listaenlazada<T>::add_end(T data_)
{
    Node<T> *new_node = new Node<T> (data_);
    Node<T> *temp = m_head;
...
template<typename T>
void listaenlazada<T>::add_sort(T data_)
{
    Node<T> *new_node = new Node<T> (data_);
    Node<T> *temp = m_head;
...
template<typename T>
void listaenlazada<T>::concat(List list)
{
...
template<typename T>
void listaenlazada<T>::del_by_data(T data_)
{
    Node<T> *temp = m_head;
...
template<typename T>
void listaenlazada<T>::del_by_position(int pos)
{
    Node<T> *temp = m_head;
...
template<typename T>
void listaenlazada<T>::fill_by_user(int dim)
{
    T ele;
    for (int i = 0; i < dim; i++) {
...
template<typename T>
void listaenlazada<T>::fill_random(int dim)
{
    srand(time(NULL));
    for (int i = 0; i < dim; i++) {
        add_end(rand() % 100);
...
template<typename T>
void listaenlazada<T>::intersection(List list_2)
{
    Node<T> *temp = m_head;
...
template<typename T>
void listaenlazada<T>::load_file(string file)
{
    T line;
    ifstream in;
    in.open(file.c_str());
...
template<typename T>
void listaenlazada<T>::search(T data_)
{
    Node<T> *temp = m_head;
    int cont = 1;
    int cont2 = 0;
...
template<typename T>
void listaenlazada<T>::save_file(string file)
{
    Node<T> *temp = m_head;
    ofstream out;
    out.open(file.c_str());
